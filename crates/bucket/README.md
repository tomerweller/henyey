...
BucketList implementation for henyey.
...
This crate provides a complete Rust implementation of the bucket list, compatible with stellar-core's bucket format and semantics.
...
```rust
use henyey_bucket::{Bucket, BucketEntry};
