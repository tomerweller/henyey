...
///
/// ```
/// use henyey_crypto::encode_contract;
///
...
///
/// ```
/// use henyey_crypto::{encode_contract, decode_contract};
///
/// let contract_hash = [0xABu8; 32];
/// let strkey = encode_contract(&contract_hash);
...
///
/// ```
/// use henyey_crypto::encode_signed_payload;
///
...
///
/// ```
/// use henyey_crypto::{encode_signed_payload, decode_signed_payload};
///
/// let pubkey = [0x01u8; 32];
/// let payload = b"memo:12345";
/// let strkey = encode_signed_payload(&pubkey, payload);
