...
//! - **HMAC-SHA256**: Message authentication codes (internal)
//! - **HKDF**: Key derivation (internal)
//! - **XDR hashing**: Hashing of XDR-encoded values
...
//!
//! ```
//! use henyey_crypto::{SecretKey, sha256};
//!
