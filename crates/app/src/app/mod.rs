...
pub struct App {
    ...
    scp_pv_drift_range: AtomicU64,
    scp_pv_drift_close_time: AtomicU64,
    scp_pv_drift_cannot_receive: AtomicU64,
    scp_pv_self_message: AtomicU64,
    scp_pv_non_quorum: AtomicU64,
    scp_pv_too_far: AtomicU64,
    scp_pv_buffer_full: AtomicU64,
    scp_pv_accepted: AtomicU64,
    scp_pv_buffered: AtomicU64,
    scp_pv_duplicate: AtomicU64,
    scp_pv_processed_directly: AtomicU64,
    scp_pv_invalid_sig: AtomicU64,
    scp_pv_panic: AtomicU64,
...
impl App {
    ...
    pub async fn new_with_clock_and_connection_factory(
        ...
        Ok(Self {
            ...
            scp_pv_drift_range: AtomicU64::new(0),
            scp_pv_drift_close_time: AtomicU64::new(0),
            scp_pv_drift_cannot_receive: AtomicU64::new(0),
            scp_pv_self_message: AtomicU64::new(0),
            scp_pv_non_quorum: AtomicU64::new(0),
            scp_pv_too_far: AtomicU64::new(0),
            scp_pv_buffer_full: AtomicU64::new(0),
            scp_pv_accepted: AtomicU64::new(0),
            scp_pv_buffered: AtomicU64::new(0),
            scp_pv_duplicate: AtomicU64::new(0),
            scp_pv_processed_directly: AtomicU64::new(0),
            scp_pv_invalid_sig: AtomicU64::new(0),
            scp_pv_panic: AtomicU64::new(0),
    ...
    pub fn info(&self) -> AppInfo {
        ...
        AppInfo {
            ...
            scp_verify: ScpVerifyMetrics {
                ...
                pv_drift_range: self.scp_pv_drift_range.load(Ordering::Relaxed),
                pv_drift_close_time: self.scp_pv_drift_close_time.load(Ordering::Relaxed),
                pv_drift_cannot_receive: self.scp_pv_drift_cannot_receive.load(Ordering::Relaxed),
                pv_self_message: self.scp_pv_self_message.load(Ordering::Relaxed),
                pv_non_quorum: self.scp_pv_non_quorum.load(Ordering::Relaxed),
                pv_too_far: self.scp_pv_too_far.load(Ordering::Relaxed),
                pv_buffer_full: self.scp_pv_buffer_full.load(Ordering::Relaxed),
                pv_accepted: self.scp_pv_accepted.load(Ordering::Relaxed),
                pv_buffered: self.scp_pv_buffered.load(Ordering::Relaxed),
                pv_duplicate: self.scp_pv_duplicate.load(Ordering::Relaxed),
                pv_processed_directly: self.scp_pv_processed_directly.load(Ordering::Relaxed),
                pv_invalid_sig: self.scp_pv_invalid_sig.load(Ordering::Relaxed),
                pv_panic: self.scp_pv_panic.load(Ordering::Relaxed),
