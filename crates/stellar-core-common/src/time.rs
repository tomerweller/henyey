...
///
/// ```rust
/// use stellar_core_common::time::current_timestamp;
///
/// let now = current_timestamp();
...
///
/// ```rust
/// use stellar_core_common::time::current_timestamp_ms;
///
...
///
/// ```rust
/// use stellar_core_common::time::timestamp_to_system_time;
///
...
///
/// ```rust
/// use stellar_core_common::time::{unix_to_stellar_time, STELLAR_EPOCH};
///
...
///
/// ```rust
/// use stellar_core_common::time::{stellar_to_unix_time, STELLAR_EPOCH};
///
