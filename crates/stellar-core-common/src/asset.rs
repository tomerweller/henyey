...
//!
//! ```rust
//! use stellar_core_common::asset::{is_ascii_alphanumeric, is_string_valid};
//!
...
///
/// ```rust
/// use stellar_core_common::asset::is_string_valid;
///
/// assert!(is_string_valid("Hello World!"));
...
///
/// ```rust
/// use stellar_core_common::asset::iequals;
///
...
///
/// ```rust
/// use stellar_core_common::asset::asset_code_to_str;
///
...
///
/// ```rust
/// use stellar_core_common::asset::str_to_asset_code;
///
...
///
/// ```rust
/// use stellar_core_common::asset::asset_to_string;
...
///
/// ```rust
/// use stellar_core_common::asset::is_asset_valid;
...
///
/// ```rust
/// use stellar_core_common::asset::compare_asset;
/// use stellar_xdr::curr::Asset;
///
...
///
/// ```rust
/// use stellar_core_common::asset::get_issuer;
/// use stellar_xdr::curr::Asset;
///
...
///
/// ```rust
/// use stellar_core_common::asset::add_balance;
///
/// // Adding to balance
...
///
/// ```rust
/// use stellar_core_common::asset::round_down;
///
...
///
/// ```rust
/// use stellar_core_common::asset::unsigned_to_signed_32;
///
...
///
/// ```rust
/// use stellar_core_common::asset::unsigned_to_signed_64;
///
...
///
/// ```rust
/// use stellar_core_common::asset::format_size;
///
