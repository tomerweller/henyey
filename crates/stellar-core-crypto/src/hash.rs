...
//!
//! ```
//! use stellar_core_crypto::blake2;
//!
...
//!
//! ```
//! use stellar_core_crypto::{hmac_sha256, hmac_sha256_verify};
//!
//! let key = [0u8; 32];
...
//!
//! ```
//! use stellar_core_crypto::{hkdf_extract, hkdf_expand};
//!
...
///
/// ```
/// use stellar_core_crypto::sub_sha256;
///
/// let seed = [0u8; 32];
...
///
/// ```
/// use stellar_core_crypto::{blake2, blake2_multi};
///
...
///
/// ```
/// use stellar_core_crypto::Blake2Hasher;
///
...
///
/// ```
/// use stellar_core_crypto::hmac_sha256;
///
/// let key = [0u8; 32];
/// let mac = hmac_sha256(&key, b"message");
/// ```
...
///
/// ```
/// use stellar_core_crypto::{hmac_sha256, hmac_sha256_multi};
///
/// let key = [0u8; 32];
...
///
/// ```
/// use stellar_core_crypto::hkdf_extract;
///
...
///
/// ```ignore
/// use stellar_core_crypto::xdr_sha256;
...
///
/// ```ignore
/// use stellar_core_crypto::xdr_blake2;
