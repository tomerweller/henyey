...
Rust: `crates/stellar-core-bucket/` (286 tests across 21 modules + 3 integration test files)
...
| # | C++ Test | Rust Equivalent | Status | Notes |
|---|----------|-----------------|--------|-------|
| 3.1 | `skip list` - skip list calculation | `stellar-core-ledger/header.rs:test_calculate_skip_values` | **COVERED** | In different crate (ledger) |
...
\* Some C++ test cases with multiple sections are counted as one.
...
The Rust bucket crate has extensive testing beyond what the C++ tests cover:
