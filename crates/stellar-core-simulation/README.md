...
This crate provides partial parity with the upstream C++ `src/simulation/*` module. The C++ implementation includes additional features like:

- Multiple topology types
- Detailed timing control
- Integration with the full application stack

As the Rust implementation matures, more of these capabilities will be added.
