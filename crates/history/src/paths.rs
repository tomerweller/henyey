...
/// ```
/// use henyey_common::Hash256;
/// use henyey_history::paths::bucket_path;
///
...
///
/// ```
/// use henyey_history::paths::checkpoint_path_dirty;
///
/// assert_eq!(
...
///
/// ```
/// use henyey_history::paths::is_dirty_path;
/// use std::path::Path;
///
...
///
/// ```
/// use henyey_history::paths::dirty_to_final_path;
/// use std::path::Path;
///
